...
- **Breaking** — the old column name `customer_age` will cease to exist; any consumer referencing it in SELECT, WHERE, JOIN, or configuration will fail at compile or runtime
